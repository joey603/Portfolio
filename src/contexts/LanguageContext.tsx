...
const translations = {
  en: {
    ...
    'jobMatch.localPowered': 'Local fallback analysis',
    'jobMatch.localNote': 'This result is based on transparent keyword matching. If the free AI provider is busy, the local analysis stays available.',
  ...
  fr: {
    ...
    'jobMatch.localPowered': 'Analyse locale de secours',
    'jobMatch.localNote': 'Ce résultat est basé sur une correspondance transparente de mots-clés. Si l’IA gratuite est occupée, l’analyse locale reste disponible.',
  ...
  he: {
    ...
    'jobMatch.localPowered': 'ניתוח מקומי לגיבוי',
    'jobMatch.localNote': 'התוצאה מבוססת על התאמת מילות מפתח שקופה. אם ספק ה-AI החינמי עמוס, הניתוח המקומי עדיין זמין.',
